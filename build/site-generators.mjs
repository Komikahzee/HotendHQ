...
export const GENERATORS = [
  ...
  { slug: 'drone-frame', name: 'Drone frame generator', cat: 'hobby', tags: ['STL', 'Whoop to 7″'],
    blurb: 'FPV quad frames from 65 mm whoops to 7-inch, with your motor pattern, stack size and camera mount.' },
